              ...
              double **P, double **T, int **Flags)
{
    ...
    write_vtkPointCoordinates(fp, xOffset, yOffset, imax, jmax, dx, dy);
    ...
    fprintf(fp, "\n");
    fprintf(fp, "SCALARS geometry int\n");
    fprintf(fp, "LOOKUP_TABLE geometry \n");
    for (j = 1; j < jmax + 1; j++)
    {
        for (i = 1; i < imax + 1; i++)
        {
...
{
    double originX = xOffset;
    double originY = yOffset;
